	...
	return (
		<>
			<ContentWithImage title='0A' images={[Image_0A]} imageSide='left' imagePos='center' titlePos='center'>
				...
				<Typography>- Admin related to the community. (Mods, documentation and
			...
			<ContentWithImage title='1-1' images={[Image_11]} imageSide='left' imagePos='center' titlePos='center'>
				...
				<Typography>- Utilising a variety weapons, vehicles and equipment to provide a diverse capability to the CO.</Typography>
				<br />
			...
			<ContentWithImage title='1-3-0' images={[Image_130]} imageSide='left' imagePos='center' titlePos='center'>
				...
				<Typography>They are responsible for;</Typography>
				<br />
				<Typography>- Command of all assets 1-3 both in and out of game.</Typography>
				<Typography>- Admin related to 1-3 platoon.</Typography>
				<Typography>- Reinforcing 1-3 support positions when required.</Typography>
				<br />
				<Typography>If not operating on the ground as a HQ element., 1-3 HQ assists call signs by filling empty 1-3 slots for missions, helping out Zeus’s when required and then simply filling empty spots in other call signs.</Typography>
				<br />
