    ...
    return (
        <div className='h-full w-full p-10 pt-[100px]'>
            <div className='m-auto max-w-[500px] flex flex-col justify-center gap-5'>
                ...
                <Link className={member.hasRoles(['All Staff']) ? 'visible' : 'hidden'} href='/dashboard/members'><Button variant='contained' fullWidth startIcon={<ManageAccounts />}>Manage Members</Button></Link>
