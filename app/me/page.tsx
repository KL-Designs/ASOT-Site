...
import { Paper, Divider, Typography, Button, TextField } from '@mui/material'
    ...
    return (
        <div className='h-full w-full p-10 flex flex-col justify-center'>
            ...
            <div className='flex justify-center gap-5 flex-wrap'>
                <div className='flex flex-wrap justify-center items-center gap-5 max-w-[1000px]'>
                    <Paper elevation={1} className='p-5 flex flex-col justify-between gap-5 w-full min-h-[250px]'>
                        <div className='flex gap-5'>
                            ...
                            <div className='w-full flex flex-wrap gap-5 justify-between'>
                                ...
                                {client.hasRoles(me, ['HQ Staff']) ? <BioInfo /> : null}
                            </div>
                        </div>

                        <Divider />

                        {client.hasRoles(me, ['HQ Staff']) ? <Bio /> : null}
                    </Paper>
                ...
                <Paper elevation={1} className='p-5 flex flex-col gap-1 flex-grow lg:flex-grow-0'>
                    <Typography variant='h5' textTransform='uppercase' letterSpacing={3} fontWeight={600} textAlign='left'>Roles</Typography>
